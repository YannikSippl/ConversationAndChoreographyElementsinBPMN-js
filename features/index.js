...
import ConversationContextPad from './ConversationContextPad';
...
export default {
    __init__: [
        ...
        'conversationPalette',
        'conversationRules',
        'conversationCanConnectPatch',
        'conversationInteractionEvents',
        'conversationOutlineProvider',
        'conversationContextPad'
    ],
    ...
    conversationContextPad: ['type', ConversationContextPad]
